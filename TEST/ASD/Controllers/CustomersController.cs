...
namespace ASD.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Customer_ID,Customer_Firstname,Customer_Lastname,Customer_Cell,Customer_Home,Customer_Address,Customer_State,Customer_Zip")] Customer customer)
        {
            if (ModelState.IsValid)
            {
